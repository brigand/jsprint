...
(function() {
  var FunctionWatcher, errorCopy, handleError, jsprint, panelTypes, printToNode, rootElement, row, _ref,
    __slice = [].slice;
  ...
  if ((_ref = document.body) != null ? _ref.appendChild : void 0) {
  ...
  FunctionWatcher = (function() {
    ...
    FunctionWatcher.prototype.updateResult = function(newArgs) {
      var child, error, errorNode, node, result, _i, _len, _ref1;
      try {
      ...
      _ref1 = this.resultView.children;
